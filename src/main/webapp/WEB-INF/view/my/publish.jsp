...
<body>
	<form id="form1">
		...
		<textarea name="content1" cols="100" rows="8"
			style="width: 1103.16px; height: 200px; visibility: hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br /> <input type="button" class="btn btn-info" name="button" value="发布文章" onclick="publish()"/> 
	</form>
...
function publish(){
 ...
 $(function(){
	 ...
	 $("#channel").change(function(){
		 ...
		 $("#category").empty();//先清空原有的分类的内容
		 //根据栏目ID查询分类
		 $.get("/channel/categorys",{channelId:channelId},function(list){
				//遍历分类
				for(var i in list){
